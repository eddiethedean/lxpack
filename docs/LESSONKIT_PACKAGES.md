...
[LessonKit 1.0](https://github.com/eddiethedean/lessonkit) and [LXPack 0.7.0](https://github.com/eddiethedean/lxpack) are complementary: **LessonKit owns React authoring and the author CLI**; **LXPack owns validation, learner runtime, and LMS export**.
...
Published from this repository. **Current release: 0.7.0.** Requires Node.js **18+**.
