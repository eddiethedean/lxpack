...
[LessonKit 1.0](https://github.com/eddiethedean/lessonkit) and [LXPack 0.6.4](https://github.com/eddiethedean/lxpack) are complementary: **LessonKit owns React authoring and the author CLI**; **LXPack owns validation, learner runtime, and LMS export**.
