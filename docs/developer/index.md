...
Technical references for **v0.3.2** contributors and integrators.
...
| **3 — Modern standards** | **v0.3.2** | Shipped | xAPI, cmi5, analytics / simulation tracking |
