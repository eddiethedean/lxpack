...
| **2 — Runtime expansion** | **v0.2.x** | **Shipped** (latest [v0.2.2](../CHANGELOG.md#022---2026-05-24)) | SCORM 2004 multi-SCO, branching, manifest variables, quiz engine upgrades, `@lxpack/components` |
