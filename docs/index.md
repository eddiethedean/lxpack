...
!!! info "Roadmap"
    **v0.3.2** is the current release. Deeper AI CLI tooling is planned for a future phase; today you author files (with Claude or by hand) and run `lxpack` to validate, preview, and build.
