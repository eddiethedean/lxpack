...
<div class="lx-hero">
  <div class="lx-hero-badges">
    <span class="lx-badge lx-badge--accent">v0.7.0</span>
...
<div class="lx-callout">
  <strong>Node.js:</strong> 18 or 20 for <code>lxpack</code> CLI · LessonKit <code>lessonkit package</code> requires <code>@lxpack/api</code> 0.7.0+.
</div>
