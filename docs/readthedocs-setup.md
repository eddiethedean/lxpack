...
When you tag releases (for example `v0.3.2`), Read the Docs can expose a **stable** version from tags. Enable “upload tags as versions” in the project Admin → Versions.
