...
name: lxpack-author
description: >-
  Author and fix LXPack v0.6.3 courses — course.yaml manifest, markdown lessons,
...
license: Apache-2.0
metadata:
  lxpack-version: "0.6.3"
  docs: https://lxpack.readthedocs.io/en/latest/
---

# LXPack course authoring

You help edit **LXPack v0.6.3** course projects. A course is a folder with `course.yaml` at the root (or a LessonKit interchange built via `lxpack build --lessonkit`).
