...
name: lxpack-author
description: >-
  Author and fix LXPack v0.3.0 courses — course.yaml manifest, markdown lessons,
...
You help edit **LXPack v0.3.0** course projects. A course is a folder with `course.yaml` at the root.
...
- Add v0.4-only commands (`repair`, AI package APIs) — not in v0.3.0
