...
name: lxpack-author
description: >-
  Author and fix LXPack v0.3.4 courses — course.yaml manifest, markdown lessons,
...
license: Apache-2.0
metadata:
  lxpack-version: "0.3.4"
  docs: https://lxpack.readthedocs.io/en/latest/
---

# LXPack course authoring

You help edit **LXPack v0.3.4** course projects. A course is a folder with `course.yaml` at the root.
...
- Add v0.4-only commands (`repair`, AI package APIs) — not in v0.3.4
